...
if __name__ == "__main__":
    ...
    model_families = ["red","red","red","red",
                      "blue","blue","blue",
                      "green","green",
    ...
    plant_caps  = [9, 6, 10]
    allowed_model_families_per_plant = [
        {"red", "blue"},   # North
        {"red", "green"},  # East
        {"blue", "green"}, # West
    ]
    ...
    res_soft = optimize_plants_assignment(
        ...
        allowed_model_families_per_plant=allowed_model_families_per_plant,
        additive_objectives=specs,
        w_group=1.2,   # grouping penalty on
        w_plants=1.0,  # prefer fewer plants
        min_allowed_qty_of_items_same_family_in_a_plant=0,  # HARD min OFF
        soft_min_qty_of_items_same_family_in_a_plant=6,     # SOFT min = 6
        w_soft_min_qty_of_items_same_family_in_a_plant=.1, # give the penalty meaningful weight
        time_limit_s=5,
        log=False
    )
    print("#=== SOFT MIN ONLY ===")
    ...
    # --- Run B: HARD minimum only (must reach 6 per family×plant to run there) ---
    ...
    #     w_group=1.2,
    #     w_plants=1.0,
    #     min_allowed_qty_of_items_same_family_in_a_plant=6,   # HARD min ON
    #     soft_min_qty_of_items_same_family_in_a_plant=0,      # SOFT min OFF
    #     time_limit_s=5,
    #     log=False
    # )
    # print("\n#=== HARD MIN ONLY ===")
